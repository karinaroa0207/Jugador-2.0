...
/**
 * Controlador del juego. Coordina la interacción entre el Modelo (Datos)
 * y la Vista (Presentación).
 */
public class JuegoController {
    ...
    /**
     * Método auxiliar para encontrar el nodo anterior a uno dado.
     * Se hace porque la lista es simplemente enlazada.
